...
// 👑 Rutas Administrativas - REPARADO
try {
  const adminRoutes = require('./routes/admin');
  app.use('/api/admin', authMiddleware(['admin', 'super_admin']), adminRoutes);
  console.log('✅ Ruta /api/admin configurada');
} catch (error) {
  console.warn('⚠️ Admin routes no disponibles:', error.message);
}

// 📦 Rutas de Paquetes - REPARADO
try {
